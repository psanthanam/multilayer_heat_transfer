function Flux = calJoz(omega,thickness_list, epsilon_list,kx_list,targetLayer,sourceLayer)
%This function calculate the heat flux for souce joz
...
%   targetLayer:    at which layer that you can to calculate the flux, should
%                   be a lossless layer
